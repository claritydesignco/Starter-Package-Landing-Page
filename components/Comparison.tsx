export default function Comparison() {
  ...
  const getIcon = (value: string) => {
    if (value === "none") return <span className="text-red-500 text-2xl">✗</span>;
    if (value === "warning") return <span className="text-yellow-500 text-2xl">⚠️</span>;
    if (value === "included" || value === "specialist") return <span className="text-green-500 text-2xl">✓</span>;
