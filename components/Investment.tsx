   ...
   <div className="max-w-5xl mx-auto">
    ...
    <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-2xl p-12 mb-12 shadow-2xl">
     ...
     <div className="text-center mt-8">
      <div className="inline-block bg-green-500 text-white px-6 py-3 rounded-full font-bold">
    ...
    <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-10 border-2 border-red-400 mb-12">
     <div className="text-center mb-6">
      <div className="inline-block bg-red-500 text-white px-6 py-3 rounded-full font-bold mb-4">
     ...
     <div className="bg-white rounded-lg p-6 border-l-4 border-orange-500">
      <h4 className="font-bold text-gray-900 mb-4">TIMING MATTERS:</h4>
    ...
    <div className="text-center">
     <a
      href="#contact"
      className="inline-block bg-black text-white px-12 py-6 rounded-xl font-bold hover:bg-gray-800 transition-all shadow-2xl hover:shadow-3xl hover:scale-105 transform"
     >
