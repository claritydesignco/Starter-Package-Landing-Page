      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-10 border-2 border-blue-200 mb-12">
          ...
          <div className="bg-white rounded-xl p-8 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-red-50 border-2 border-red-300 rounded-lg p-6">
                <p className="font-bold text-lg text-red-700 mb-3">Option A:</p>
              ...
              <div className="bg-green-50 border-2 border-green-300 rounded-lg p-6">
                <p className="font-bold text-lg text-green-700 mb-3">Option B:</p>
                <p className="text-gray-700">
          ...
          <p className="text-center text-lg font-semibold text-gray-900 mb-6">
            Only <span className="text-red-600 text-2xl">2 spots remaining</span> for January 2026.<br />
          ...
          <div className="text-center">
            <a
              href="#contact"
              className="inline-block bg-black text-white px-12 py-6 rounded-xl text-2xl font-bold hover:bg-gray-800 transition-all shadow-2xl hover:shadow-3xl mb-6"
            >
